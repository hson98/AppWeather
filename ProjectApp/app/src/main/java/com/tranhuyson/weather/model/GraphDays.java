...
public class GraphDays extends View {
    Paint mPaintPoints;
    Paint mPaintLines;
    Paint mPaintText;
    Paint mPainLine2;
    ...
    public GraphDays(Context context) {
        super(context);
        init();
    }

    public GraphDays(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public GraphDays(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }


    public GraphDays(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("O", 32, 1220, mPaintText);
        canvas.drawText("Time", 840, 1300, mPaintText);
        //ºC
